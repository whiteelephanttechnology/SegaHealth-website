      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-6xl font-bold text-black mb-6 capitalize leading-tight">
          ...
          <div className="text-center">
            <Button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-full text-xl font-medium shadow-lg">
              Get Certified Today
            </Button>
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4 mb-8">
                  <Badge variant="secondary" className="px-4 py-2">Professional Grade</Badge>
                  <Badge variant="secondary" className="px-4 py-2">Easy Financing Options</Badge>
                  <Badge variant="secondary" className="px-4 py-2">Full Training Included</Badge>
                </div>
